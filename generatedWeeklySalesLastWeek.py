...
App runs fake data on last weeks dates for real time initiation.
Creates realistic_weekly_sales_data_last_week.csv file
...
# Shift to 7 days ago
last_week_today = datetime.today() - timedelta(days=7)


# Custom range between April 5, 2025 and April 14, 2025
...
for _ in range(2000):
    ...
    # Random purchase date in that range
...
realistic_weekly_path = "realistic_weekly_sales_data_last_week.csv"
